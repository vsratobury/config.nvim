...
Kickstart.nvim is a template for your own configuration. The goal is that you
can read every line of code, top-to-bottom, understand what your configuration
is doing, and modify it to suit your needs.

  Once you've done that, you should start exploring, configuring and tinkering
  to explore Neovim!
...
I have left several `:help X` comments throughout the init.lua You should run
that command and read that help section for more information.

In addition, I have some `NOTE:` items throughout the file. These are for you,
the reader to help understand what is happening. Feel free to delete them once
you know what you're doing, but they should serve as a guide for when you are
first encountering a few different constructs in your nvim config.
...
require('lazy').setup({
  ...
  -- keeping up-to-date with whatever is in the kickstart repo. Uncomment the
  -- following line and add your plugins to `lua/custom/plugins/*.lua` to get
  -- going.
  --
  --    For additional information see:
  --    https://github.com/folke/lazy.nvim#-structuring-your-plugins { import =
  --    'custom.plugins' },
}, {})
...
-- Выбор полноцветного режима в терминале, если он его поддерживает
-- TODO: использовать список известных терминалов
if vim.env.TERM == 'xterm-kitty' then
  vim.o.termguicolors = true
end

-- Подсвечивать строку где находиться курсор
vim.o.cursorline = true

--  Подсвечивать границу где будет назодиться 80 символ в строке
vim.o.colorcolumn = '80'

-- Показывать невидимые символы
vim.o.list = true;

-- Плавная прокрутка страницы, прокрутка начинается за 10
-- строк до границы видимой области
vim.o.scrolloff = 10
vim.o.sidescrolloff = 10

-- Новые окна будут открывать с права при вертикальном делении
-- и снизу при горизонтальном делениии окна
vim.o.splitright = true
vim.o.splitbelow = true

-- Установить опции форматирования
vim.o.formatoptions = 'croqnj'

-- Использовать короткие сообщения
vim.o.shortmess = 'atToOFc'

-- [[Русская раскладка клавиатуры]]
-- :h russian-keymaps
--
-- Есть несколько вариантов использования, первый переключать раскладку в nvim
-- <C-^> только в режиме вставки. Можно использовать когда нет возможности
-- переключить раскладку в системе.
...
vim.keymap.set('n', '<leader>t', ':vsplit term://fish<cr>',
  { desc = 'Open Terminal with Fish shell' })
...
-- See `:help nvim-treesitter` Defer Treesitter setup after first render to
-- improve startup time of 'nvim {filename}' @diagnostic disable: missing-field
vim.defer_fn(function ()
  require('nvim-treesitter.configs').setup {
    -- Add languages to be installed here that you want installed for treesitter
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'vim', 'bash', 'fish', 'cmake', 'json', 'markdown' },
